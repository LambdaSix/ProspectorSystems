...
namespace ProspectorSystems.Data.Script
{
    ...
    public class Logger
    {
        ...
        {
            Sandbox.ModAPI.MyAPIGateway.Utilities.InvokeOnGameThread(delegate { Logger.Instance.LogException(ex, showNotice); });
        }
        #endregion
        ...
        public void LogException(Exception ex, bool showNotice = true)
        {
            ...
            if (ex.InnerException != null)
            {
                ...
                Logger.Instance.LogException(ex.InnerException, showNotice);
            }
